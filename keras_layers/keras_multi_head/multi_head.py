...
class MultiHead(keras.layers.Wrapper):
    ...
    def __init__(self,
        ...
        :param layer: The layer to be duplicated or a list of keras_layers.
        :param layer_num: The number of duplicated keras_layers.
        :param hidden_dim: A linear transformation will be applied to the input data if provided, otherwise the original
                           data will be feed to the sub-keras_layers.
    ...
    def from_config(cls, config, custom_objects=None):
        ...
        if reg_slice is not None:
            ...
            reg_slice = slices
        layers = [keras.layers.deserialize(layer, custom_objects=custom_objects) for layer in config.pop('keras_layers')]
