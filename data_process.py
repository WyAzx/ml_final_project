...
def main():
    ...
    train["comment_text"] = pattern_tokenizer.process_ds(train["comment_text"]).str.join(sep=" ")
    test["comment_text"] = pattern_tokenizer.process_ds(test["comment_text"]).str.join(sep=" ")
